...
Phone spam and scam calls are a familiar problem. `phone:number` makes it possible to judge whether a given number has been trustworthy, abusive, spammy, useful, or otherwise worth answering, blocking, or ranking differently.
